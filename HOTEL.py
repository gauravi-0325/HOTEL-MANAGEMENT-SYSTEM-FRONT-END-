...
root.iconbitmap(r"C:/Users/user/Downloads/Icons-Land-Buildings-Hotel-5-Stars.512.png")
root.title("HOTEL MANAGEMENT SYSTEM")

'''logo = PhotoImage(file=.JPG")
root.iconphoto(False, logo)'''

#Label(root, text="Youtube Video Downloader", font=("Lucida handwriting", 50, "bold","underline"),bg="steelblue",fg="white").pack(padx=5, pady=50)


#link = StringVar()
Label(root, text="Enter the link:- ", font=("forte", 35, "bold","underline"),fg="brown",bg="steelblue").place(x=100, y=150)
Entry_link = Entry(root, width=50, font=35, textvariable=link).place(x=35, y=220)

img=PhotoImage(file=r"C:/Users/user/Desktop/project/youtube-logo-png-31796.png")
Label(root,image=img).place(x=650,y=150)  
